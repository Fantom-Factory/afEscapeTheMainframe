...
//		g.clear(Color(0xFF_00_00_33))
		...
		g3d := Gfx3d(g.offsetCentre).lookAt(camera, Point3d(0f, 0f, 0f))
...
//			x -= 20
		...
		camera = camera.translate(0f, 0f, -1f)
//		camera = camera.translate(0f, 0f, -300f)
	}
	
	Int x
	
	Point3d camera	:= Point3d(0f, 600f, 0f) 
}
