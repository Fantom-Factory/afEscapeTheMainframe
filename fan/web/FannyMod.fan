	...
	Void onIndexPage(WebOutStream out, Uri reqAbsUri) {
		...
		out.body
			...
			out.div("class='bgScreen'")
				...
				out.div("class='twits'")
					out.a(`https://twitter.com/intent/tweet`, "class='twitter-share-button' data-text='Fanny the Fantom; a jump game rendered in stunning retro 3D vector graphics, written in #fantomLang & #javascript' data-url='http://fanny.fantomfactory.org/'").w("Tweet").aEnd
				out.divEnd
